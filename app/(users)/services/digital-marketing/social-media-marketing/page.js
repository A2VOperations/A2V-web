...
export default function SocialMediaMarketingPage() {
  const source = "social-media-marketing";
  ...
  return (
    <main className="min-h-screen bg-white">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-20">
            <div className="flex-1 text-center lg:text-left">
              ...
              <p className="text-xl text-gray-400 mb-12 max-w-xl mx-auto lg:mx-0 leading-relaxed font-medium">
                We build community, foster real engagement, and turn followers
                into loyal brand advocates through creative storytelling and
                viral-native content.
              </p>
            ...
            <div className="flex-1 relative w-full max-w-2xl">
              <div className="relative aspect-square rounded-[3rem] overflow-hidden border-2 border-white/10 shadow-2xl group">
                ...
                {/* Floating Stat Card */}
                <div className="absolute top-10 left-10 p-8 bg-white/10 backdrop-blur-2xl rounded-3xl border border-white/20 shadow-2xl animate-bounce-slow">
      ...
      <ServiceFAQ source="social-media-marketing" />
      <Contact />
    </main>
  );
}
