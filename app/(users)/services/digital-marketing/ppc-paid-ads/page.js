...
export default function PPCAdsPage() {
  ...
  return (
    <main className="min-h-screen bg-white">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-20">
            <div className="flex-1 text-center lg:text-left">
              ...
              <h1 className="text-6xl md:text-8xl font-black mb-8 uppercase tracking-tighter leading-[0.85]">
                PPC & <br /> <span className="text-orange-500">Paid Ads</span>
              </h1>
              <p className="text-xl text-gray-400 mb-12 max-w-xl mx-auto lg:mx-0 leading-relaxed font-medium">
                Maximize every dollar of your ad spend with precision targeting,
                high-converting creative, and obsessive performance
                optimization.
              </p>
      ...
      <ServiceFAQ source="ppc-paid-ads" />
      <Contact />
    </main>
  );
}
