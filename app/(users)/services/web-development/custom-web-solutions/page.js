...
export default function CustomWebSolutionsPage() {
  const source = "custom-web-solutions";
  ...
  return (
    <main className="min-h-screen bg-white">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-20">
            <div className="flex-1 text-center lg:text-left">
              ...
              <p className="text-xl text-gray-400 mb-12 max-w-xl mx-auto lg:mx-0 leading-relaxed font-medium">
                We build high-performance, custom-tailored web applications
                designed to solve complex business problems and scale with your
                growth.
              </p>
            ...
            <div className="flex-1 relative w-full max-w-2xl">
              <div className="relative aspect-square rounded-[3rem] overflow-hidden border-2 border-orange-500/20 shadow-2xl group">
                <Image
                  src="https://images.unsplash.com/photo-1555066931-bf19f8fd1085?q=80&w=2071&auto=format&fit=crop"
                  alt="Web Solutions Showcase"
                  fill
      ...
      <ServiceFAQ source="custom-web-solutions" />
      <Contact />
    </main>
  );
}
