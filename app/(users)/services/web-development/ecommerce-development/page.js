...
export default function EcommerceDevelopmentPage() {
  const source = "ecommerce-development";
  ...
  return (
    <main className="min-h-screen bg-white">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-20">
            <div className="flex-1 text-center lg:text-left">
              ...
              <p className="text-xl text-gray-400 mb-12 max-w-xl mx-auto lg:mx-0 leading-relaxed font-medium">
                We build high-converting online stores that merge premium design
                with powerful functionality to drive exponential sales growth.
              </p>
            ...
            <div className="flex-1 relative w-full max-w-2xl">
              <div className="relative aspect-square rounded-[3rem] overflow-hidden border-2 border-orange-500/20 shadow-2xl group">
                ...
                />
                <div className="absolute top-10 left-10 p-8 bg-white/10 backdrop-blur-2xl rounded-3xl border border-white/20 shadow-2xl">
      ...
      <ServiceFAQ source="ecommerce-development" />
      <Contact />
    </main>
  );
}
