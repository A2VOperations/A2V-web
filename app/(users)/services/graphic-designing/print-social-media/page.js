...
export default function PrintSocialMediaPage() {
  const source = "print-social-media";
  ...
  return (
    <main className="min-h-screen bg-white">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-20">
            <div className="flex-1 text-center lg:text-left">
              ...
              <h1 className="text-6xl md:text-8xl font-black mb-8 uppercase tracking-tighter leading-[0.85]">
                Print & <span className="text-orange-500">Social</span> <br />{" "}
                Design
              </h1>
              <p className="text-xl text-gray-400 mb-12 max-w-xl mx-auto lg:mx-0 leading-relaxed font-medium">
                From high-resolution print materials to viral-ready social media
                assets, we ensure your brand looks premium across every medium.
              </p>
            ...
            <div className="flex-1 relative w-full max-w-2xl">
              <div className="relative aspect-square rounded-[3rem] overflow-hidden border-2 border-white/10 shadow-2xl group -rotate-2">
                <Image
                  src="https://images.unsplash.com/photo-1541462608141-ad603aae355a?q=80&w=2070&auto=format&fit=crop"
                  alt="Design Showcase"
                  fill
      ...
      <ServiceFAQ source="print-social-media" />
      <Contact />
    </main>
  );
}
