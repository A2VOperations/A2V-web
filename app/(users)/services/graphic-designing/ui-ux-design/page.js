...
export default function UIUXDesignPage() {
  ...
  return (
    <main className="min-h-screen bg-white">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-20">
            <div className="flex-1 text-center lg:text-left">
              ...
              <h1 className="text-6xl md:text-8xl font-black mb-8 uppercase tracking-tighter leading-[0.85]">
                UI/UX <br /> <span className="text-orange-500">Mastery</span>
              </h1>
              <p className="text-xl text-gray-400 mb-12 max-w-xl mx-auto lg:mx-0 leading-relaxed font-medium">
                We design intuitive, high-performance interfaces that bridge the
            ...
            <div className="flex-1 relative w-full max-w-2xl">
              <div className="relative aspect-square rounded-[3rem] overflow-hidden border-2 border-white/10 shadow-2xl group scale-105 rotate-2">
                <Image
      ...
      <ServiceFAQ source="ui-ux-design" />
      <Contact />
    </main>
  );
}
