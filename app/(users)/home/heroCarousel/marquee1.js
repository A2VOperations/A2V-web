  ...
  return (
    <div className="relative w-full overflow-hidden shadow-lg">
      ...
      <div
        ...
        onMouseEnter={pause}
        onMouseLeave={resume}
        className="flex w-max animate-ticker1 "
      >
        {repeated.map((stat, i) => (
          <React.Fragment key={i}>
            <div className="flex flex-row items-center justify-center gap-3 px-8 py-3.5 whitespace-nowrap ">
              <span className="text-lg leading-tight tracking-tight text-orange-500 md:text-xl bg-white font-bold">
                {stat.value}
              </span>
      ...
      <style>{`
        ...
        .animate-ticker1 {
          animation: ticker1 28s linear infinite;
