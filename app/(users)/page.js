        ...
        <div className="z-10 mx-auto w-full max-w-7xl">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center relative">
            <div className="lg:col-span-7 flex flex-col justify-center">
              ...
              <h1 className="text-4xl font-bold leading-tight text-black sm:text-6xl lg:text-5xl">
                NextGen AI-Powered Web Solutions
              </h1>
              <h2 className="mt-3 text-2xl font-medium leading-tight text-black sm:text-5xl xl:text-4xl">
                and{" "}
